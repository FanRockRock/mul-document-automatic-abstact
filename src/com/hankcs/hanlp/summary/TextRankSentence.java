...
//                "三，无限的算法，是那些由于没有定义终止定义条件，或定义的条件无法由输入的数据满足而不终止运行的算法。通常，无限算法的产生是由于未能确定的定义终止条件。";
        Map<String, SentenceParagraphPosition> map=FileIO.getParaPosi(FileIO.readFile("E:/JavaWorkspace/多文档语料库/朝鲜核问题"));
        ...
        List<String> list=TextRankSentence.getTopSentenceList(document, 5);
//        for(String s:list)
//        	System.out.println(s);
//        System.out.println("---------------------------");
        //定义一个装最好结果的TreeMap
        Map<SentenceParagraphPosition,String> treeMap = new TreeMap<>(new Comparator<SentenceParagraphPosition>(){
            public int compare(SentenceParagraphPosition o1, SentenceParagraphPosition o2){
    ...
    static List<String> spiltSentence(String document)
    {
        ...
        for (String sent : document.split("。"))
           {
                sent = sent.trim();
